...
const Header = ({ menus, logo, megamenuImage }) => {
  return (
    ...
    <nav className="c-site-header__navbar navbar navbar-expand-lg">
      <div className="container">
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <img className="navbar-toggler-icon" src="./assets/images/toggler.png" alt="Toggle" />
        </button>
                ...
                <div className="row">
                  <div className="col-3 d-none d-lg-block">
                    <div className="dropdown-item-wrap">
                      <img src={megamenuImage} className="img-fluid" alt="Image" />
                    </div>
                  </div>
